...
try {
    ...
    $checkQuery = "SELECT idplanclases FROM planclases WHERE idplanclases = ?";
    ...
    $queryReservas = "DELETE FROM reserva WHERE re_idRepeticion = ?";
    $stmtReservas = $reserva2->prepare($queryReservas);
    ...
    $queryAsignaciones = "DELETE FROM asignacion WHERE idplanclases = ?";
